...
export const appName = "Artify";
export const appSubtitle = "Forget using a mouse to edit your photos use your words instead";
export const appMetaDescription = "By Fisidi Inc.";
